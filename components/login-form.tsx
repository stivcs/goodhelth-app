...
export function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.email === "admin@goodhelth.com") {
        router.push("/admin")
      } else if (formData.email.includes("doctor") || formData.email.includes("psicologo")) {
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-muted/50 p-3 rounded-lg text-xs space-y-1">
            ...
            <p>Admin: admin@goodhelth.com</p>
            <p>Profesional: doctor@goodhelth.com</p>
            <p>Usuario Premium: premium@goodhelth.com</p>
            <p>Usuario Free: user@goodhelth.com</p>
          </div>
